...
import { fetchQuoteById, publishQuote, updateQuoteStatus, sendQuotePromptEmail, fetchOrgSettings } from '../lib/db';
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ink-50)' }}>
      ...
      >
        ...
        >
          © 2026 Nexova · Software Empresarial · contacto@nexova.pe
        </div>
      </div>
