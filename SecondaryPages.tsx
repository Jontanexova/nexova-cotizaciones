...
import type { Vendor, VendorRole } from '../lib/types';
...
export function Users() {
  ...
  return (
    <div className="fade-in">
      ...
      {/* Modal: mostrar credenciales recién creadas */}
      {createdUser && (
        <CredentialsModal
          title="Usuario creado"
          subtitle={`Copia estas credenciales y compártelas de forma segura con ${createdUser.name}. La contraseña no se podrá recuperar después.`}
      ...
      {/* Modal: password reseteada */}
      {resetPasswordFor && (
        <CredentialsModal
          title="Contraseña reseteada"
          subtitle={`Comparte la nueva contraseña con ${resetPasswordFor.vendor.name}. La contraseña anterior ya no funciona.`}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div className="nx-field">
            ...
            <span className="nx-hint">
              {role === 'super_admin'
                ? 'Acceso total: ver, crear, modificar todo incluyendo usuarios y ajustes.'
                : role === 'seller'
