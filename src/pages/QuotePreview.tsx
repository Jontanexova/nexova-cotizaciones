...
import { Avatar, Loading, Modal, NexovaLogo, StatusChip, Toast } from '../components/UI';
    ...
    <div style={{ minHeight: '100vh', background: 'var(--ink-50)' }}>
      ...
      >
        ...
        <div style={{ padding: '32px 40px' }}>
          ...
          {/* v2.25 — Notas y Condiciones: default global o override de esta cotización. */}
          {(() => {
            const isCustom = !!(quote.terms && quote.terms.trim());
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <span
                      className={`nx-chip ${isCustom ? 'chip-amber' : 'chip-slate'}`}
                      style={{ fontSize: 10.5 }}
                    >
                      {isCustom ? 'Personalizadas' : 'Default global'}
                    </span>
                  </div>
                  <button
                ...
                {lines.length > 0 ? (
                  ...
                  >
                    No hay notas configuradas. Un Super Admin puede definir las
                    notas por defecto en <strong>Ajustes → Organización</strong>,
                    o puedes personalizarlas solo para esta cotización con el
                    botón de arriba.
                  </div>
                )}
              </div>
