...
# Deploy la función — IMPORTANTE: usar --no-verify-jwt
# La auth se hace manualmente dentro del código (igual que refresh-exchange-rate).
# Si deployas con verify_jwt activado, el gateway de Supabase rechaza los
# requests con 401 antes de ejecutar el código aunque el JWT sea válido.
